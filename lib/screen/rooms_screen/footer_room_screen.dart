...
class FooterRoomScreen extends StatelessWidget {
  const FooterRoomScreen({super.key});
          ...
          Align(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Image(width: 18,height: 18,image: AssetImage('assets/images/icon_twitter.png')),
                  Image(width: 18,height: 18,image: AssetImage('assets/images/icon_instagram.png')),
                  Image(width: 18,height: 18,image: AssetImage('assets/images/icon_facebook.png')),
                  Image(width: 18,height: 18,image: AssetImage('assets/images/icon_youtube.png')),
                ],
              ),
            ),
          ),
